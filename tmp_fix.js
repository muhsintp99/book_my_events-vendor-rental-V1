...
`;
fs.writeFileSync('d:/real copy/Vendor Panel/Vendor Panel/src/lightdashboard/LightAreaChartCard.jsx', content, 'utf8');
console.log('File written successfully in UTF-8');
