...
export default function InvitationEarningCard({ isLoading, totalEarnings = 0 }) {
...
InvitationEarningCard.propTypes = { isLoading: PropTypes.bool, totalEarnings: PropTypes.number };
