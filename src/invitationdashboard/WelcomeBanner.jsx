        ...
        >
            ...
            <Box
                sx={{
                    position: 'relative',
                    overflow: 'hidden',
                    background: 'linear-gradient(135deg, #e15b65 0%, #c14a54 45%, #a13943 100%)',
                    borderRadius: 3,
                    px: { xs: 3, md: 4 },
                    py: { xs: 2.5, md: 3 },
                    minHeight: 135,
                    ...
                    display: 'flex',
                    alignItems: 'center',
                    boxShadow: '0 14px 35px rgba(225, 91, 101, 0.35)',
                    transition: '0.3s ease',

                    '&:hover': {
                        transform: 'translateY(-3px)',
                        boxShadow: '0 22px 45px rgba(225, 91, 101, 0.45)'
                    }
                }}
            >
                {/* Decorative circle */}
                ...
                <Box sx={{ position: 'relative', zIndex: 1 }}>
                    ...
                    >
                        {kycStatus === 'verified' ? 'Welcome to BookMyEvent! ✨' : kycStatus === 'pending' ? 'Verification in Progress ⏳' : 'Welcome aboard! 🎉'}
                    </Typography>
                    ...
                    >
                        {kycStatus === 'verified' ? (
                            <>
                                It&apos;s great to have you with us. Your account is fully verified and ready to handle your Invitation & Printing business seamlessly.
                            </>
                        ) : (
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', mb: 1.5, gap: 1.5 }}>
                    <Box
                        sx={{
                            ...
                            height: 42,
                            borderRadius: '12px',
                            background: isSubscribed ? 'rgba(245, 158, 11, 0.1)' : 'rgba(225, 91, 101, 0.08)',
                            color: isSubscribed ? '#f59e0b' : '#e15b65'
                        }}
                    >
                        {isSubscribed ? (
