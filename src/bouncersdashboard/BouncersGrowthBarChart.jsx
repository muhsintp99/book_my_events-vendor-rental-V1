...
export default function BouncersGrowthBarChart({ 
  isLoading, 
        ...
        <MainCard>
          <Stack sx={{ gap: gridSpacing }}>
            <Stack direction="row" sx={{ alignItems: 'center', justifyContent: 'space-between' }}>
              <Stack sx={{ gap: 0.5 }}>
                <Typography variant="subtitle2" color="textSecondary">Bouncers Enquiry Growth</Typography>
...
BouncersGrowthBarChart.propTypes = { 
