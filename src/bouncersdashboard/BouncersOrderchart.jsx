            ...
            {isLoading ? (
                ...
                <MainCard
                    ...
                    sx={{
                        ...
                        overflow: 'hidden',
                        position: 'relative',
                        boxShadow: '0 8px 32px 0 rgba(33, 33, 33, 0.3)',
                        '&:after': {
                            content: '""',
                            position: 'absolute',
                            width: 210,
                            ...
                            <Stack direction="row" justifyContent="space-between" alignItems="center">
                                ...
                                <Stack direction="row" spacing={1}>
                                    <Button
                                        ...
                                        sx={{ color: '#fff', bgcolor: isMonth ? 'rgba(255, 255, 255, 0.1)' : 'transparent', '&:hover': { bgcolor: 'rgba(255, 255, 255, 0.2)' } }}
                            ...
                            <Stack direction="row" alignItems="center" spacing={2}>
                                ...
                                >
                                    {isMonth && monthChart ? (
                                        ...
                                        <Typography
                                            variant="subtitle2"
                                            sx={{ textAlign: 'center', mt: 4, color: 'rgba(255, 255, 255, 0.4)' }}
                                        >
                                            No data
                                        </Typography>
                                    )}
