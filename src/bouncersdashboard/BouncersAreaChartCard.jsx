...
// ===========================|| BOUNCERS AREA CHART CARD ||=========================== //

export default function BouncersAreaChartCard({
    title = 'Bouncers',
    amount = 1839,
    chartConfig,
    height = 160
    ...
    // Coral theme colors (shared with Mehandi for now as per "like mehandi" request)
...
BouncersAreaChartCard.propTypes = {
