...
export default function PanthalPopularCard({ isLoading, enquiries = [], totalEnquiryRevenue = 0 }) {
      ...
      {isLoading ? (
        ...
        >
          <CardContent sx={{ p: 3 }}>
            ...
            <PanthalAreaChartCard totalEnquiries={enquiries.reduce((sum, e) => sum + e.count, 0)} />
              ...
              {enquiries.length === 0 && (
                <Box sx={{ py: 4, textAlign: 'center' }}>
                  <Typography variant="caption" color="text.secondary">
                    No enquiry data to display yet.
                  </Typography>
                </Box>
              )}
            </Box>
