...
export default function PanthalIncomeLightCard({ isLoading, total, icon, label }) {
...
PanthalIncomeLightCard.propTypes = { isLoading: PropTypes.bool, total: PropTypes.number, icon: PropTypes.node, label: PropTypes.string };
