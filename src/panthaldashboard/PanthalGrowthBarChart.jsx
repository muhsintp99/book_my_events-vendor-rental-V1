...
export default function PanthalGrowthBarChart({ 
  isLoading, 
  ...
  const displayTotal = useMemo(() => {
     // For simplicity in this focus on enquiries, we display total
        ...
        <MainCard>
          <Stack sx={{ gap: gridSpacing }}>
            <Stack direction="row" sx={{ alignItems: 'center', justifyContent: 'space-between' }}>
              <Stack sx={{ gap: 0.5 }}>
                <Typography variant="subtitle2" color="textSecondary">Panthal Enquiry Growth</Typography>
...
PanthalGrowthBarChart.propTypes = { 
