...
export default function OrnamentsEarningCard({ isLoading, totalEarnings = 0 }) {
...
OrnamentsEarningCard.propTypes = { isLoading: PropTypes.bool, totalEarnings: PropTypes.number };
