...
export default function VehicleEarningCard({ isLoading, totalEarnings = 0 }) {
      ...
      {isLoading ? (
        ...
        <MainCard
          ...
          sx={{
            ...
            position: 'relative',
            height: 190,
            boxShadow: '0 8px 32px 0 rgba(211, 47, 47, 0.3)',
            '&:after': {
              content: '""',
              position: 'absolute',
              width: 210,
...
VehicleEarningCard.propTypes = { isLoading: PropTypes.bool, totalEarnings: PropTypes.number };
