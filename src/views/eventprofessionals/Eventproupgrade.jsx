...
export default function EventproUpgradePlanUI() {
            ...
            try {
                ...
                if (res.data.success) {
                    ...
                    if (subRes.data.success && subRes.data.subscription) {
                        ...
                        setTimeout(() => {
                            window.location.replace('/eventprofessionals/portfolio');
                        }, 2000);
                    }
                } else {
                    setSnackbar({
        ...
        <Box sx={{ minHeight: '100vh', bgcolor: '#f9fafc', py: 6 }}>
            <Box maxWidth="md" mx="auto" px={2}>
                ...
                <Typography textAlign="center" color="text.secondary" mb={3}>
                    Choose the best plan for your Event Professional business
                </Typography>
