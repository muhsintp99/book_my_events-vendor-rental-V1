...
const THEME_COLOR = '#4527A0'; // Coral theme for Emcee
        ...
        try {
            ...
            if (data.success) {
                ...
                const filtered = (data.data || []).filter(b => {
                    ...
                    return type.includes('eventpro') || type.includes('professional');
                });
    ...
    const fetchModules = async () => {
        try {
            ...
            const filteredModules = modulesList.filter(module => {
                ...
                return moduleTitle.includes('eventpro') || moduleTitle.includes('professional');
            });
                        ...
                        <Grid item xs={12} md={6} lg={4} key={b._id}>
                            <Paper sx={{ p: 3, borderRadius: '24px', position: 'relative', overflow: 'hidden', border: '1px solid #f0f0f0', boxShadow: '0 8px 20px rgba(0,0,0,0.02)' }}>
                                ...
                                <Stack spacing={1}>
                                    ...
                                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, color: '#666' }}><EngineeringIcon sx={{ fontSize: 16 }} /><Typography variant="body2">Event Pro Service</Typography></Box>
                                </Stack>
                            </Paper>
                        </Grid>
                    ))
