        ...
        MuiOutlinedInput: {
            styleOverrides: {
                root: {
                    ...
                    '&.Mui-focused fieldset': { borderColor: '#4527A0 !important', borderWidth: '2px' }
                },
...
export default function AddEventproPackage() {
    ...
    useEffect(() => {
        ...
        const fetchPackage = async () => {
            try {
                ...
                const res = await fetch(`${API_BASE_URL}/api/event-professional/${id}`, {
                    headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const url = isEditMode
                ? `${API_BASE_URL}/api/event-professional/${id}`
                : `${API_BASE_URL}/api/event-professional/create`;
    ...
    return (
        <ThemeProvider theme={theme}>
            <CssBaseline />
            <Box sx={{ width: '100%', bgcolor: '#F8F5FF', minHeight: '100%', py: { xs: 3, sm: 4 }, px: { xs: 2, sm: 3, md: 4 } }}>
                {/* Page Heading */}
                <Box sx={{ mb: 3.5 }}>
                ...
                >
                    <Avatar sx={{ bgcolor: 'rgba(69,39,160,0.3)', borderRadius: '10px', width: 38, height: 38, fontSize: '15px' }}>✦</Avatar>
                    <Box>
                        <Typography sx={{ color: '#EDE7F6', fontFamily: "'Playfair Display', serif", fontSize: '1.05rem' }}>Package Details</Typography>
                ...
                <Box
                    ...
                    noValidate
                    sx={{
                        border: '1px solid rgba(69,39,160,0.11)',
                        borderTop: 'none',
                        borderRadius: '0 0 16px 16px',
                        bgcolor: '#F8F5FF',
                        p: { xs: 2, sm: 3 },
                        boxShadow: '0 4px 24px rgba(69,39,160,0.06)'
                    }}
                >
                    <Stack spacing={2.5}>
                        {/* ── 1. Package Name ── */}
                        <Paper elevation={0} sx={card}>
                            ...
                            <TextField
                                label="Package Name *"
                                placeholder="e.g. Wedding Coordinator Package"
                                fullWidth
                                value={form.name}
                        ...
                        <Paper elevation={0} sx={card}>
                            ...
                            <TextField
                                label="Description *"
                                placeholder="Describe your event professional services, expertise, and specialties..."
                                fullWidth
                                multiline
                                rows={4}
                                    ...
                                    {services.map((svc) => (
                                        <Chip
                                            ...
                                            sx={{
                                                ...
                                                '&.MuiChip-outlined': { borderColor: 'rgba(69, 39, 160, 0.3)', color: 'text.secondary' }
                                            }}
                                        />
                                    ))}
                                </Box>
                            ...
                            {imagePreview ? (
                                <Box sx={{ position: 'relative', borderRadius: '12px', overflow: 'hidden' }}>
                                    <Box
                                        ...
                                        sx={{
                                            ...
                                            display: 'block',
                                            borderRadius: '12px',
                                            border: '1.5px solid rgba(69,39,160,0.15)'
                                        }}
                                    />
                                    <IconButton
                                        onClick={() => {
                                ...
                                <Box
                                    ...
                                    sx={{
                                        ...
                                        border: `2px dashed ${errors.image ? '#d32f2f' : drag ? '#4527A0' : 'rgba(69,39,160,0.28)'}`,
                                        borderRadius: '12px',
                                        py: { xs: 4.5, sm: 5.5 },
                                        px: 3,
                                        cursor: 'pointer',
                                        bgcolor: drag ? 'rgba(69,39,160,0.04)' : '#F8F5FF',
                                        textAlign: 'center',
                                        transition: 'all 0.2s',
                                        '&:hover': { borderColor: '#4527A0', bgcolor: 'rgba(69,39,160,0.03)' }
                                    }}
                                >
                                    <input id="pkg-img" type="file" accept="image/*" hidden onChange={(e) => loadImg(e.target.files[0])} />
                                    <Avatar sx={{ bgcolor: 'rgba(69,39,160,0.1)', width: 52, height: 52, mb: 1.75, borderRadius: '13px' }}>
                                        <CloudUpload sx={{ color: '#4527A0', fontSize: 24 }} />
                                    </Avatar>
                                    ...
                                    <Stack direction="row" spacing={0.75} flexWrap="wrap" justifyContent="center">
                                        {['JPG', 'PNG', 'WEBP', 'Max 5MB'].map((f) => (
                                            <Chip
                                                ...
                                                label={f}
                                                size="small"
                                                sx={{ bgcolor: 'rgba(69,39,160,0.08)', color: '#311B92', fontSize: '11px', height: 24 }}
                                            />
                                        ))}
                                    </Stack>
                                </Box>
                        ...
                        <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.5} alignItems={{ sm: 'center' }} pt={0.5}>
                            <Button
                                ...
                                sx={{
                                    ...
                                    boxShadow: '0 4px 18px rgba(69, 39, 160, 0.32)',
                                    '&:hover': { boxShadow: '0 6px 24px rgba(69, 39, 160, 0.44)', transform: 'translateY(-1px)' },
                                    transition: 'all 0.2s'
                                }}
                            >
                                {busy
                            ...
                            <Button
                                ...
                                sx={{
                                    ...
                                    py: 1.65,
                                    fontSize: '15px',
                                    borderColor: 'rgba(69,39,160,0.28)',
                                    color: 'primary.dark',
                                    '&:hover': { borderColor: 'primary.main', bgcolor: 'rgba(69,39,160,0.04)' }
                                }}
                            >
                                Reset
                            </Button>
