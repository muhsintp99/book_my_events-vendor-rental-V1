...
{booking.timeSlot?.length
  ...
  : 'All Day'}
                ...
                <p style={styles.bookingLocation}>{booking.vehicleId?.name || 'Vehicle not specified'}</p>
                ...
                <Select name="vehicleId" value={formData.vehicleId} onChange={handleInputChange} label="Select Vehicle">
                  ...
                  {vehicles.map((vehicle) => (
                    <MenuItem key={vehicle._id} value={vehicle._id}>
                      {vehicle.name} • {vehicle.seatingCapacity} Seater • AED {vehicle.pricing?.perDay}/day
                    </MenuItem>
                  ))}
                </Select>
              </FormControl>
