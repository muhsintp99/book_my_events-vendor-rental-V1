...
const THEME = {
    primary: '#673ab7',
    secondary: '#4527a0',
    gradient: 'linear-gradient(135deg, #673ab7 0%, #4527a0 100%)',
        ...
        const fetchEnquiries = async () => {
            try {
                ...
                const customizations = all.filter(e => {
                    ...
                    const isLight = moduleType.includes('light') ||
                        moduleType.includes('sound') ||
        ...
        <Box sx={{
            ...
            {(!isMobile || mobileChatOpen) && (
                <Box sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column', bgcolor: '#F8FAFC' }}>
                                    ...
                                    {activeEnquiry?.packageDetails && (
                                        <Box
                                            sx={{
                                                ...
                                                '&:hover': {
                                                    boxShadow: '0 6px 20px rgba(103, 58, 183, 0.1)',
                                            ...
                                            <Box sx={{ minWidth: 0, flexGrow: 1 }}>
                                                ...
                                                <Stack direction="row" alignItems="center" spacing={0.5}>
                                                    ...
                                                    <IconButton
                                                        size="small"
                                                        component="a"
                                                        href={`https://bookmyevent.ae/light-details.html?id=${activeEnquiry.packageId}`}
                                                        target="_blank"
                                                        sx={{
                                                            p: 0,
                                                            color: THEME.primary,
                    ...
                    {/* Chat Messages */}
                    <Box sx={{ flexGrow: 1, overflowY: 'auto', p: isMobile ? 1.5 : 3, display: 'flex', flexDirection: 'column', gap: 2, backgroundImage: 'radial-gradient(#673ab710 1px, transparent 1px)', backgroundSize: '20px 20px' }}>
                        {chatLoading ? (
                                ...
                                return (
                                    <Box key={msg._id || idx} sx={{ alignSelf: isVendor ? 'flex-end' : 'flex-start', maxWidth: { xs: '90%', md: '70%' }, display: 'flex', flexDirection: 'column', alignItems: isVendor ? 'flex-end' : 'flex-start' }}>
                                        <Paper sx={{
                                            ...
                                            boxShadow: isVendor ? '0 8px 16px rgba(103, 58, 183, 0.2)' : '0 4px 12px rgba(0,0,0,0.05)',
