                                            ...
                                            <Stack direction="row" spacing={1} justifyContent="center">
                                                <Tooltip title="Chat">
                                                    <IconButton
                                                        ...
                                                        color="primary"
                                                        onClick={() => {
                                                            navigate('/light/enquirychat', { state: { enquiry: e } });
                                                        }}
                                                    >
                ...
                <DialogActions>
                    ...
                    <Button
                        ...
                        onClick={() => {
                            ...
                            setOpenChat(true);
                            navigate('/light/enquirychat', { state: { enquiry: selectedEnquiry } });
                        }}
                    >
                        Open Chat
                    </Button>
