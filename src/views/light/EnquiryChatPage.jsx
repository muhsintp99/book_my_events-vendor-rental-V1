                                                ...
                                                <ListItemText
                                                    ...
                                                    secondary={
                                                        <Typography variant="body2" noWrap sx={{ maxWidth: '200px', color: '#64748B', fontSize: '0.8rem' }}>
                                                            {enq.moduleId?.title || enq.email || 'Light & Sound Enquiry'}
                                                        </Typography>
                                                    }
                                                />
                                            </ListItemButton>
                                            ...
                                            >
                                                <Paper
                                                    ...
                                                    sx={{
                                                        ...
                                                        boxShadow: fromMe ? '0 4px 12px rgba(103, 58, 183,0.3)' : '0 2px 8px rgba(0,0,0,0.06)',
                                ...
                                >
                                    ...
                                    <IconButton
                                        ...
                                        sx={{
                                            ...
                                            '&.Mui-disabled': { bgcolor: '#d1c4e9', color: 'white' }
                                        }}
                                    >
