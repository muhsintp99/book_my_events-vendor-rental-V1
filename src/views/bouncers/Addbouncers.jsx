...
const theme = createTheme({
  palette: {
    primary: { main: '#0f172a', dark: '#020617', light: '#1e293b', contrastText: '#fff' },
...
export default function AddBouncersPackage() {
  ...
  useEffect(() => {
    ...
    const fetchPackage = async () => {
      try {
        ...
        const res = await fetch(`${API_BASE_URL}/api/bouncers-security/${id}`, {
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = isEditMode
        ? `${API_BASE_URL}/api/bouncers-security/${id}`
        : `${API_BASE_URL}/api/bouncers-security/create`;
        ...
        >
          <Stack spacing={2.5}>
            ...
            <Paper elevation={0} sx={card}>
              ...
              <TextField
                label="Package Name *"
                placeholder="e.g. Professional Bouncer Squad"
                fullWidth
                value={form.name}
                      ...
                      return (
                        <Box
                          ...
                          sx={{
                            ...
                            bgcolor: active ? 'rgba(15,23,42,0.06)' : '#fff',
                            transition: 'all 0.2s cubic-bezier(0.4, 0, 0.2, 1)',
                            '&:hover': {
                              borderColor: active ? 'primary.main' : 'rgba(15,23,42,0.3)',
