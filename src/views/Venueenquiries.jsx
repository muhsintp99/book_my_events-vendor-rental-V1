  ...
  useEffect(() => {
    const fetchEnquiries = async () => {
      ...
      try {
        ...
        const allEnquiries = res.data.data || [];
        const venueEnquiries = allEnquiries.filter((enquiry) => {
          return (
            enquiry.moduleId?.moduleType?.toLowerCase() === "venue" ||
            enquiry.moduleId?.title?.toLowerCase().includes("venue") ||
            enquiry.moduleId?._id === "68e5ea9f27ca1c19b2d3924a"
          );
        });
        setEnquiries(venueEnquiries);
        setError(null);
      } catch (err) {
              ...
              {!loading &&
                filteredEnquiries.map((e, i) => (
                  <TableRow key={e._id} hover>
                    ...
                    <TableCell>{e.packageDetails?.venueName || e.moduleId?.title}</TableCell>
      ...
      <Dialog open={openModal} onClose={handleCloseModal} maxWidth="md" fullWidth>
        <DialogTitle sx={{ bgcolor: "primary.main", color: "white" }}>
          <Box display="flex" justifyContent="space-between">
            <Typography fontWeight={600}>Venue Enquiry Details</Typography>
                ...
                <Card variant="outlined">
                  <CardContent>
                    ...
                    <DetailRow
                      ...
                      label="Venue"
                      value={selectedEnquiry.packageDetails?.venueName || selectedEnquiry.moduleId?.title}
                    />
                    <DetailRow
