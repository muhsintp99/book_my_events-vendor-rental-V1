...
const Multizones = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const profileRes = await axios.get(`${API_BASE}/api/vendorprofiles/find/${vendorId}?moduleId=${PHOTOGRAPHY_MODULE_ID}`);
      ...
      if (profileRes.data.success && profileRes.data.data) {
        ...
        setVendorProfile({ providerId: vendorId, module: PHOTOGRAPHY_MODULE_ID });
      }
    } catch (err) {
        ...
        <Box>
          ...
          <Typography variant="h6" color="text.secondary" sx={{ fontWeight: 400, opacity: 0.8, ml: 9 }}>
            {isEdit 
              ...
              : 'Maximize your visibility across premium service areas.'
            }
          </Typography>
        </Box>
