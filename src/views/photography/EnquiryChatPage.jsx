...
var ACCENT = '#0288D1';
var ACCENT_DARK = '#01579B';
var ACCENT_LIGHT = '#E1F5FE';
var ACCENT_BG = '#F5FBFF';
...
var EnquiryChatPage = function () {
  ...
  var isMe = function (sid) {
    return String(sid) === String(vendorId);
  };

  // Fetch photography enquiries
  useEffect(
    function () {
      if (!vendorId) {
        setLoading(false);
      ...
      var doFetch = async function () {
        try {
          ...
          var filtered = all.filter(function (e) {
            ...
            return mt === 'photography' || title.includes('photo') || title.includes('video');
          });
  ...
  useEffect(
    function () {
      ...
      var handleReceive = function (data) {
        ...
        setMessages(function (prev) {
          var exists = prev.some(function (msg) {
            return msg._id === data._id || (msg.timestamp && msg.timestamp === data.timestamp && msg.senderId === data.senderId);
          });
                        ...
                        <ListItemText
                          ...
                          secondary={
                            <Typography variant="body2" noWrap sx={{ maxWidth: '200px', color: '#64748B', fontSize: '0.8rem' }}>
                              {enq.moduleId?.title || enq.email || 'Photography Enquiry'}
                            </Typography>
                          }
                        />
                      </ListItemButton>
                      ...
                      >
                        <Paper
                          ...
                          sx={{
                            ...
                            boxShadow: fromMe ? '0 4px 12px rgba(2,136,209,0.3)' : '0 2px 8px rgba(0,0,0,0.06)',
                ...
                >
                  ...
                  <IconButton
                    ...
                    sx={{
                      ...
                      '&.Mui-disabled': { bgcolor: ACCENT_LIGHT, color: 'white' }
                    }}
                  >
