...
var ACCENT = '#467ace';
var ACCENT_DARK = '#5677ad';
var ACCENT_LIGHT = '#F3E5F5';
var ACCENT_BG = '#FDFBFE';
      ...
      var doFetch = async function () {
        try {
          ...
          var filtered = all.filter(function (e) {
            ...
            return mt === 'ornaments' || mt === 'jewelry' || title.includes('ornament') || title.includes('jewelry');
          });
                        ...
                        <ListItemText
                          ...
                          secondary={
                            <Typography variant="body2" noWrap sx={{ maxWidth: '200px', color: '#64748B', fontSize: '0.8rem' }}>
                              {enq.moduleId?.title || enq.email || 'Ornaments Enquiry'}
                            </Typography>
                          }
                        />
                      </ListItemButton>
                      ...
                      >
                        <Paper
                          ...
                          sx={{
                            ...
                            boxShadow: fromMe ? '0 4px 12px rgba(123,31,162,0.3)' : '0 2px 8px rgba(0,0,0,0.06)',
