...
//     if (vehicle.brand && vehicle.brand._id && !updatedBrands.some((b) => b._id === vehicle.brand._id)) {
//       updatedBrands.push({
...
//     if (vehicle.category && vehicle.category._id && !updatedCategories.some((c) => c._id === vehicle.category._id)) {
...
//       fetchVehicle();
//     }
//   }, [isDataLoaded, vehicleId, vehicleKeyFromState, setVehicleData]);
...
//                 </Typography>
//                 <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
//                   Insert the vehicle's unique 17-character alphanumeric code.
//                 </Typography>
