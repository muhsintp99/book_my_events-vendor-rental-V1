        ...
        <DialogContent>
          {selectedVenue && (
            <Grid container spacing={2}>
              ...
              <Typography>{selectedVenue.category || "-"}</Typography>
              </Grid>
              <Grid item xs={12} sm={6}>
                <Typography variant="subtitle1" fontWeight="bold">Latitude</Typography>
                <Typography>{selectedVenue.latitude || "-"}</Typography>
              ...
              <Grid item xs={12}>
                ...
                {selectedVenue.pricingSchedule && selectedVenue.pricingSchedule.length > 0 ? (
                  <MuiTableContainer component={Paper} sx={{ mt: 1 }}>
                    <Table size="small">
                      ...
                      <TableBody>
                        {selectedVenue.pricingSchedule.map((slot, index) => (
                          <TableRow key={index}>
