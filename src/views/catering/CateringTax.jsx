  ...
  return (
    <StyledContainer>
      ...
      <Box display="flex" alignItems="center" mb={2}>
        ...
        <Button
          variant="contained"
          sx={{ ml: 2, backgroundColor: '#E15B65', '&:hover': { backgroundColor: '#e73b47ff' } }} >
          Filter
        </Button>
      </Box>
...
export default CateringtaxReport;