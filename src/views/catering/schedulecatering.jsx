          ...
          <div style={styles.bookingsContainer}>
            {selectedBookings.map((booking) => (
              ...
              >
                ...
                <p style={styles.bookingLocation}>{booking.cateringId?.title || 'Catering Package'}</p>
          ...
          <DialogContent sx={{ p: 3, backgroundColor: 'white', width: '500px' }}>
            ...
            <Box mb={4}>
              ...
              <FormControl fullWidth variant="outlined" sx={{ mb: 2 }}>
                ...
                >
                  <MenuItem value="">
                    <em>{packages.length === 0 ? 'No catering packages available' : `Select Package (${packages.length} available)`}</em>
                  </MenuItem>
              ...
              {packages.length === 0 && (
                <Alert severity="info" sx={{ mb: 2 }}>
                  No catering packages configured for your account.
                </Alert>
              )}
