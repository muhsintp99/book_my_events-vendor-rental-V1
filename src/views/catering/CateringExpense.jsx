...
const ExpenseReport = () => {
  ...
  const handleExport = (format) => {
    const data = 'Sl,Catering Id,Date & Time,Expense Type,Customer Name,Expense Amount%0A1,100031,2025-02-06 05:23pm,Discount On Catering,Jonathon Jack,₹17.06';
  ...
  return (
    <Box sx={{ p: 2, bgcolor: 'white' }}>
      ...
      <Typography variant="body2" color="textSecondary" gutterBottom>
        This report will show all the catering in which the Provider discount has been used. The Provider discounts are: Free delivery, Coupon discount & package discounts(partial according to catering commission).
      </Typography>
      ...
      <Table>
        <TableHead>
          <TableRow>
            ...
            <TableCell>Catering Id</TableCell>
        ...
        <TableBody>
          <TableRow>
            ...
            <TableCell>Discount On Catering</TableCell>
