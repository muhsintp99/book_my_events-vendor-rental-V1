    ...
    <Box sx={{ p: 2 }}>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-between', backgroundColor: 'white', p: 2, borderRadius: 2, mb: 4 }}>
        <Box sx={{ textAlign: 'center', p: 2, border: '1px solid #e0e0e0', borderRadius: 2, width: '18%', backgroundColor: '#f0f8ff' }}>
          ...
          <Typography variant="body2">Total catering services</Typography>
        ...
        <Box sx={{ textAlign: 'center', p: 2, border: '1px solid #e0e0e0', borderRadius: 2, width: '18%', backgroundColor: '#e8f5e9' }}>
          ...
          <Typography variant="body2">In progress <InfoIcon sx={{ fontSize: 16, color: '#4caf50' }} /></Typography>
          <Box sx={{ display: 'flex', justifyContent: 'center', mt: 1 }}>
        ...
        <Box sx={{ textAlign: 'center', p: 2, border: '1px solid #e0e0e0', borderRadius: 2, width: '18%', backgroundColor: '#e0f7fa' }}>
          ...
          <Typography variant="body2">Ongoing orders</Typography>
          <Box sx={{ display: 'flex', justifyContent: 'center', mt: 1 }}>
      ...
      <Box sx={{ backgroundColor: 'white', borderRadius: 2, p: 2 }}>
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
          <Typography variant="h6" sx={{ color: '#666' }}>
            Total orders <span style={{ color: '#999', fontSize: '14px' }}>4</span>
          </Typography>
          ...
          <Table>
            <TableHead>
              <TableRow sx={{ bgcolor: '#f5f5f5' }}>
                ...
                <TableCell sx={{ fontWeight: 'bold', fontSize: '12px', padding: '8px', whiteSpace: 'nowrap' }}>Catering Id</TableCell>
                <TableCell sx={{ fontWeight: 'bold', fontSize: '12px', padding: '8px', whiteSpace: 'nowrap' }}>Customer Info</TableCell>
                <TableCell sx={{ fontWeight: 'bold', fontSize: '12px', padding: '8px', whiteSpace: 'nowrap' }}>Total Fare </TableCell>
                <TableCell sx={{ fontWeight: 'bold', fontSize: '12px', padding: '8px', whiteSpace: 'nowrap' }}>Discount </TableCell>
                ...
                <TableCell sx={{ fontWeight: 'bold', fontSize: '12px', padding: '8px', whiteSpace: 'nowrap' }}>Total catering Amount</TableCell>
                ...
                <TableCell sx={{ fontWeight: 'bold', fontSize: '12px', padding: '8px', whiteSpace: 'nowrap' }}> Status</TableCell>
              ...
              {tripData.map((trip, index) => (
                <TableRow key={trip.id} sx={{ '&:hover': { bgcolor: '#f9f9f9' } }}>
                  ...
                  <TableCell sx={{ fontSize: '12px', padding: '8px' }}>
                    <Typography variant="body2" sx={{ color: '#fd3755ff', textDecoration: 'underline', cursor: 'pointer' }}>
                      {trip.id}
                    </Typography>
                  </TableCell>
                  <TableCell sx={{ fontSize: '12px', padding: '8px' }}>
