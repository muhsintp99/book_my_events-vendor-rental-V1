  ...
  return (
    <Box sx={{ p: 2 }}>
      <Box sx={{ mb: 4, backgroundColor: 'white', borderRadius: 2, p: 2 }}>
        <Typography variant="h4" sx={{ mb: 2 }}> Disbursement Report</Typography>
        <Box sx={{ display: 'flex', justifyContent: 'space-between', backgroundColor: 'white', p: 2, borderRadius: 2 }}>
          <Box sx={{ textAlign: 'center', p: 3, border: '1px solid #e0e0e0', borderRadius: 2, width: '30%', height: 150 }}>
            <Typography variant="h5" sx={{ color: '#4caf50' }}>$0.00</Typography>
            <Typography variant="h5">Pending Disbursements</Typography>
          ...
          <Box sx={{ textAlign: 'center', p: 3, border: '1px solid #e0e0e0', borderRadius: 2, width: '30%', height: 150 }}>
            <Typography variant="h5" sx={{ color: '#ff9800' }}>$0.00</Typography>
            <Typography variant="h5">Completed Disbursements</Typography>
            <Box sx={{ display: 'flex', justifyContent: 'center', mt: 1 }}>
          ...
          <Box sx={{ textAlign: 'center', p: 3, border: '1px solid #e0e0e0', borderRadius: 2, width: '30%', height: 150 }}>
            <Typography variant="h5" sx={{ color: '#f44336' }}>$0.00</Typography>
            <Typography variant="h5">Canceled Transactions</Typography>
            <Box sx={{ display: 'flex', justifyContent: 'center', mt: 1 }}>
