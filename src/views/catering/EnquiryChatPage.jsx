...
var ACCENT = '#6364ae';
var ACCENT_DARK = '#5666ae';
var ACCENT_LIGHT = '#E8F5E9';
var ACCENT_BG = '#F1F8E9';
                        ...
                        <ListItemText
                          ...
                          secondary={
                            <Typography variant="body2" noWrap sx={{ maxWidth: '200px', color: '#64748B', fontSize: '0.8rem' }}>
                              {enq.moduleId?.title || enq.email || 'Catering Enquiry'}
                            </Typography>
                          }
                        />
                      </ListItemButton>
                      ...
                      >
                        <Paper
                          ...
                          sx={{
                            ...
                            boxShadow: fromMe ? '0 4px 12px rgba(46,125,50,0.3)' : '0 2px 8px rgba(0,0,0,0.06)',
