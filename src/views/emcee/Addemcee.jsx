...
const theme = createTheme({
  palette: {
    primary: { main: '#dd666eff', dark: '#A33A43', light: '#FF8A92', contrastText: '#fff' },
    secondary: { main: '#ad2430ff' },
...
export default function AddEmceePackage() {
  ...
  useEffect(() => {
    ...
    const fetchPackage = async () => {
      try {
        ...
        const res = await fetch(`https://api.bookmyevent.ae/api/emcee/${id}`, {
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = isEditMode
        ? `https://api.bookmyevent.ae/api/emcee/${id}`
        : `https://api.bookmyevent.ae/api/emcee/create`;
        ...
        >
          <Stack spacing={2.5}>
            ...
            <Paper elevation={0} sx={card}>
              ...
              <TextField
                label="Package Name *"
                placeholder="e.g. Wedding Emcee Package"
                fullWidth
                value={form.name}
            ...
            <Paper elevation={0} sx={card}>
              ...
              <TextField
                label="Description *"
                placeholder="Describe your hosting style, experience, and the events you cover..."
                fullWidth
                multiline
                rows={4}
            ...
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.5} alignItems={{ sm: 'center' }} pt={0.5}>
              <Button
                ...
                sx={{
                  ...
                  py: 1.65,
                  fontSize: '15px',
                  background: 'linear-gradient(135deg, #dd666eff 0%, #ad2430ff 100%)',
                  boxShadow: '0 4px 18px rgba(221, 102, 110, 0.32)',
                  '&:hover': { boxShadow: '0 6px 24px rgba(221, 102, 110, 0.44)', transform: 'translateY(-1px)' },
                  transition: 'all 0.2s'
                }}
              >
                {busy
