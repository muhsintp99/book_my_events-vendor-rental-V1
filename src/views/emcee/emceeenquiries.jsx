...
const EmceeEnquiries = () => {
    ...
    return (
        <Box p={2}>
            <Typography variant="h4" gutterBottom sx={{ color: '#dd666eff', fontWeight: 700 }}>
                Emcee & Event Host Enquiries
            </Typography>
                                            ...
                                            <Stack direction="row" spacing={1} justifyContent="center">
                                                <Tooltip title="Chat">
                                                    <IconButton
                                                        ...
                                                        color="primary"
                                                        onClick={() => {
                                                            navigate('/emcee/enquirychat', { state: { enquiry: e } });
                                                        }}
                                                    >
            ...
            <Dialog open={openModal} onClose={handleCloseModal} maxWidth="md" fullWidth>
                <DialogTitle sx={{ bgcolor: "#dd666eff", color: "white" }}>
                ...
                <DialogActions>
                    ...
                    <Button
                        variant="contained"
                        startIcon={<ChatIcon />}
                        sx={{ bgcolor: '#dd666eff', '&:hover': { bgcolor: '#ad2430ff' } }}
                        onClick={() => {
                            setChatEnquiry(selectedEnquiry);
                            setOpenChat(true);
                            navigate('/emcee/enquirychat', { state: { enquiry: selectedEnquiry } });
                        }}
                    >
                        Open Chat
                    </Button>
