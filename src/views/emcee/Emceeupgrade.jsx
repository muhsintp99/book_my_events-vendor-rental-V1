...
export default function EmceeUpgradePlanUI() {
            ...
            try {
                ...
                if (res.data.success) {
                    ...
                    if (subRes.data.success && subRes.data.subscription) {
                        ...
                        setTimeout(() => {
                            window.location.replace('/Emcee/portfolio');
                        }, 2000);
                    }
                } else {
                    setSnackbar({
        ...
        <Box sx={{ minHeight: '100vh', bgcolor: '#f9fafc', py: 6 }}>
            <Box maxWidth="md" mx="auto" px={2}>
                ...
                <Typography textAlign="center" color="text.secondary" mb={3}>
                    Choose the best plan for your Emcee business
                </Typography>
                            ...
                            <Grid item xs={12} md={6} key={plan._id}>
                                <Card
                                    sx={{
                                        ...
                                        boxShadow: isCurrent ? '0 4px 20px rgba(76, 175, 80, 0.2)' : '0 4px 20px rgba(225, 91, 101, 0.2)'
                                    }}
                                >
                                    <CardContent>
                                        <Chip
