...
var ACCENT = '#6f81de';
var ACCENT_DARK = '#6c9dd2';
var ACCENT_LIGHT = '#FCE4EC';
var ACCENT_BG = '#FFF0F3';
                        ...
                        <ListItemText
                          ...
                          secondary={
                            <Typography variant="body2" noWrap sx={{ maxWidth: '200px', color: '#64748B', fontSize: '0.8rem' }}>
                              {enq.moduleId?.title || enq.email || 'Makeup Enquiry'}
                            </Typography>
                          }
                        />
                      </ListItemButton>
                      ...
                      >
                        <Paper
                          ...
                          sx={{
                            ...
                            boxShadow: fromMe ? '0 4px 12px rgba(233,30,99,0.3)' : '0 2px 8px rgba(0,0,0,0.06)',
