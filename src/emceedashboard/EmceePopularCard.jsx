...
export default function EmceePopularCard({ isLoading, enquiries = [] }) {
      ...
      {isLoading ? (
        ...
        >
          <CardContent sx={{ p: 3 }}>
            ...
            <EmceeAreaChartCard totalEnquiries={enquiries.reduce((sum, e) => sum + e.count, 0)} />
