...
export default function EmceeIncomeLightCard({ isLoading, total, icon, label }) {
...
EmceeIncomeLightCard.propTypes = { isLoading: PropTypes.bool, total: PropTypes.number, icon: PropTypes.node, label: PropTypes.string };
