        ...
        >
            ...
            <Box
                sx={{
                    position: 'relative',
                    overflow: 'hidden',
                    background: 'linear-gradient(135deg, #4527a0 0%, #673ab7 45%, #b39ddb 100%)',
                    borderRadius: 3,
                    px: { xs: 3, md: 4 },
                    py: { xs: 2.5, md: 3 },
                    minHeight: 135,
                    ...
                    display: 'flex',
                    alignItems: 'center',
                    boxShadow: '0 14px 35px rgba(103, 58, 183, 0.35)',
                    transition: '0.3s ease',

                    '&:hover': {
                        transform: 'translateY(-3px)',
                        boxShadow: '0 22px 45px rgba(103, 58, 183, 0.45)'
                    }
                }}
            >
                {/* Decorative circle */}
                ...
                <Box sx={{ position: 'relative', zIndex: 1 }}>
                    ...
                    >
                        {kycStatus === 'verified' ? 'Welcome to BookMyEvent! ✨' : kycStatus === 'pending' ? '' : 'Welcome aboard! 🎉'}
                    </Typography>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', mb: 1.5, gap: 1.5 }}>
                    <Box
                        sx={{
                            ...
                            height: 42,
                            borderRadius: '12px',
                            background: isSubscribed ? 'rgba(245, 158, 11, 0.1)' : 'rgba(103, 58, 183, 0.08)',
                            color: isSubscribed ? '#f59e0b' : '#673ab7'
                        }}
                    >
                        {isSubscribed ? (
