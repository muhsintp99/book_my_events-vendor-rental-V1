...
// project imports
import LightAreaChartCard from './LightAreaChartCard';
...
export default function LightPopularCard({ isLoading, enquiries = [] }) {
      ...
      {isLoading ? (
        ...
        >
          <CardContent sx={{ p: 3 }}>
            ...
            <LightAreaChartCard totalEnquiries={enquiries.reduce((sum, e) => sum + e.count, 0)} />
