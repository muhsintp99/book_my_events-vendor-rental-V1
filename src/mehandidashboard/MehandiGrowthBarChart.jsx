...
export default function MehandiGrowthBarChart({ 
  isLoading, 
  monthlyGrowth = [], 
  monthlyIncomeGrowth = [], 
  totalEarnings = 0 
        ...
        <MainCard>
          <Stack sx={{ gap: gridSpacing }}>
            <Stack direction="row" sx={{ alignItems: 'center', justifyContent: 'space-between' }}>
              <Stack sx={{ gap: 0.5 }}>
                <Typography variant="subtitle2" color="textSecondary">Mehandi Growth Performance</Typography>
...
MehandiGrowthBarChart.propTypes = { 
