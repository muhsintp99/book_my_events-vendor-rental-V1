...
// ==============================|| MEHANDI AREA CHART CARD ||============================== //

export default function MehandiAreaChartCard({ totalRevenue }) {
...
MehandiAreaChartCard.propTypes = { totalRevenue: PropTypes.number };
