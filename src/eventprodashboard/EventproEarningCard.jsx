...
export default function EventproEarningCard({ isLoading, totalEnquiryMonth = 0 }) {
            ...
            <Stack spacing={2}>
              ...
              <Stack spacing={0.5}>
                <Stack direction="row" alignItems="center" spacing={1}>
                  ...
                  >
                    {totalEnquiryMonth.toLocaleString()}
                  </Typography>
                  <Avatar
                    sx={{
                      width: 24,
...
EventproEarningCard.propTypes = {
  isLoading: PropTypes.bool,
  totalEnquiryMonth: PropTypes.number
};
