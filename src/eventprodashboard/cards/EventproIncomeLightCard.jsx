...
export default function EventproIncomeLightCard({ isLoading, total, icon, label }) {
...
EventproIncomeLightCard.propTypes = { isLoading: PropTypes.bool, total: PropTypes.number, icon: PropTypes.node, label: PropTypes.string };
