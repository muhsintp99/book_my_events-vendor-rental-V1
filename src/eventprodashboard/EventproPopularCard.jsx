...
export default function EventproPopularCard({ isLoading, enquiries = [] }) {
      ...
      {isLoading ? (
        ...
        >
          <CardContent sx={{ p: 3 }}>
            ...
            <EventproAreaChartCard totalEnquiries={enquiries.reduce((sum, e) => sum + e.count, 0)} />
