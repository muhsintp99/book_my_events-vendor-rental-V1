...
export default function FloristEarningCard({ isLoading, totalEarnings = 0 }) {
...
FloristEarningCard.propTypes = { isLoading: PropTypes.bool, totalEarnings: PropTypes.number };
