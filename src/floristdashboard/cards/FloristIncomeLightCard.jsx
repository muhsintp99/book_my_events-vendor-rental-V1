...
export default function FloristIncomeLightCard({ isLoading, total, icon, label }) {
...
FloristIncomeLightCard.propTypes = { isLoading: PropTypes.bool, total: PropTypes.number, icon: PropTypes.node, label: PropTypes.string };
