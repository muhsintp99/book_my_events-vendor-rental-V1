...
// project imports
import FloristAreaChartCard from './FloristAreaChartCard';
...
// ==============================|| FLORIST POPULAR CARD ||============================== //

export default function FloristPopularCard({ isLoading, packages = [], totalPackageRevenue = 0 }) {
      ...
      {isLoading ? (
        ...
        >
          <CardContent sx={{ p: 3 }}>
            ...
            <FloristAreaChartCard totalRevenue={totalPackageRevenue} />
