...
// ==============================|| FLORIST AREA CHART CARD ||============================== //

export default function FloristAreaChartCard({ totalRevenue }) {
...
FloristAreaChartCard.propTypes = { totalRevenue: PropTypes.number };
