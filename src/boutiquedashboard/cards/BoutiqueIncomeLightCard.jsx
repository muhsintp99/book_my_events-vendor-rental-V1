...
export default function BoutiqueIncomeLightCard({ isLoading, total, icon, label }) {
...
BoutiqueIncomeLightCard.propTypes = { isLoading: PropTypes.bool, total: PropTypes.number, icon: PropTypes.node, label: PropTypes.string };
