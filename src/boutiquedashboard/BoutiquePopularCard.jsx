...
// ==============================|| BOUTIQUE POPULAR CARD ||============================== //

export default function BoutiquePopularCard({ isLoading, packages = [], totalPackageRevenue = 0 }) {
      ...
      {isLoading ? (
        ...
        >
          <CardContent sx={{ p: 3 }}>
            ...
            <BoutiqueAreaChartCard totalRevenue={totalPackageRevenue} />
